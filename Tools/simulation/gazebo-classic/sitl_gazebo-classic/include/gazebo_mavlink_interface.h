...
private:
  ...
  void ReactionWheelRpmCallback(FloatPtr& rpm_msg);
  ...
  transport::SubscriberPtr reaction_wheel_rpm_sub_{nullptr};
  ...
  std::string reaction_wheel_rpm_sub_topic_{"/reaction_wheel/rpm"};
